...
import plus.wls.common.utils.ip.AddressUtils;
import plus.wls.common.utils.ip.IpUtils;
import plus.wls.common.utils.uuid.IdUtils;
...
public class TokenService {
    ...
    // 令牌秘钥
    @Value("${wls.token.secret}")
    private String secret;
    // 令牌有效期（默认30分钟）
    // @Value("${wls.token.expireTime}")
    private int expireTime = 60 * 24 * 10;
    @Autowired
